...
shop_id={u"蜜芽宝贝":"98",u"BV-育儿网":"93",u"BV-妈妈帮":"94",u"BV-辣妈帮":"95",u"微官":u"29",
         u"积分兑换玩具&正装":"49",u"积分兑换试用装":"48",u"BV-PCbaby":"23",u"BV-Pcbaby":"23",u"BBS-ISA":u"64",
         u"BOX":"38",u"特卖":"36",u"贝贝":u"106",u"广点通-Zone":"63",u"干货挑战":"103",
         u"干货-宝宝树":"103",u"干货-妈妈帮":"103",u"干货-妈妈网":"103",u"干货-育儿网":"103",
         u"微信菜单":"108",u"广点通QQ手机":"112",u"广点通腾讯新闻":"111",u"广点通QQ浏览器":"110",
         u"广点通微信":"109",u"考拉":u"120",u"妈妈网":u"126",
         u"BV赠品PC-育儿网":"89",u"BV赠品PC-宝宝树":"89",u"BV赠品PC-Pcbaby":"89",
         u"BV赠品-妈妈帮":"89",u"BV赠品-宝宝树":"89",u"BV赠品-育儿网":"89",u"BV赠品-Pcbaby":"89",
         u"BV赠品-微信afocus":"89",u"朋友圈":u"122",
         u"109":u"109",u"110":u"110",u"111":u"111",u"112":u"112",u"63":u"63",}
gdt_shop_id=("63","109","110","111","112","122")
gdt_barcode={u"8片S码":u"6903148235508",u"8片NB码":u"6903148235515"}
bb_barcode={u"4片XXL码":"4902430706223",u"4片XL码":"4902430706193",u"4片L码":"4902430706179",u"4片M码":"4902430706186",
            u"帮宝适特级棉柔男女拉拉裤试用装L":"4902430706179",u"帮宝适特级棉柔男女拉拉裤试用装M":"4902430706186",
            u"帮宝适超薄干爽系列拉拉裤大码1片装":"6903148239797",u"帮宝适超薄干爽系列拉拉裤中码1片装":"6903148241110",
            u"白4片L码": "4902430706179", u"白4片M码": "4902430706186",
            u"绿4片L码": "6903148239797", u"绿4片M码": "6903148241110",
            u"8片NB码":u"4902430706278",u"紫8片NB码":u"4902430706278",}
pd_barcode={u"4片L码":"6903148215159",u"8片S码":"6903148238912",u"8片NB码":"6903148238905",
            u"12片NB码":"6903148240014",u"12片S码":"6903148240021",
            u"23片L码":"6903148158333",u"52片L码":"6903148158425",
            u"帮宝适特级棉柔男女拉拉裤试用装L":"4902430706179",
            u"帮宝适特级棉柔男女拉拉裤试用装M":"4902430706186",
            u"帮宝适特级棉柔男女拉拉裤试用装XL":"4902430706193",
            u"帮宝适特级棉柔男女拉拉裤试用装XXL":"4902430706223"
            }
...
#查找表头
dictcol={}
dictcol[u"tid"]=(u"ID",u"Reward ID",u"订单号",u"订单编号",u"ID ")
dictcol[u"out_tid"]=(u"out_tid",u"订单号",u"out_id")
dictcol[u"mobilPhone"]=(u"手机号",u"mobilPhone",u"mobilePhone",u"手机",u"手机号码",u"申领手机号码",u"电话",u"收货人手机",u"电话号码")
dictcol[u"consignee"]=(u"consignee",u"姓名",u"收件人姓名",u"申领用户名",u"用户名",u"收货人",u"收件人")
dictcol[u"province"]=(u"省",u"province",u"省份",u"配送省")
dictcol[u"city"]=(u"市",u"city",u"配送市",u"城市")
dictcol[u"area"]=(u"区",u"area",u"区/县",u"配送区",u"区县")
dictcol[u"address"]=(u"收货地址",u"地址",u"address",u"用户申领地址",u"详细地址",u"addre")
dictcol[u"barCode"]=(u"barCode",u"barcode",u"bar_code",u"条码",u"SKU")
dictcol[u"address_backup"]=(u"address_backup",u"备份地址")
dictcol[u"remark"]=(u"remark",u"备注",u"说明")
dictcol[u"street"]=(u"street",u"街道")
dictcol[u"in_memo"]=(u"宝宝出身时间",u"宝宝出生时间",u"预产期/宝宝生日",u"BB日期")
dictcol[u"shop_id"]=(u"shop-id",u"shop_id",u"渠道",)
dictcol[u"order_date"]=(u"order_date",u"order date",u"Issue Date",u"数据日期",u"日期",u"注册时间",)
dictcol[u"product_title"]=(u"商品名称",u"产品名称",u"申领片数",u"Reward Name",u"圣通商品名称",u"圣通产品名称")
dictcol[u"city_class"]=(u"城市级别",u"城级")
dictcol[u"buyer_id"]=(u"id",u"会员姓名",u"Member Account ID",u"ID",u"consignee",u"内部id",u"收货人")
...
dictcol[u"wrong_reason"]=(u"DLVRYNBR-REJRSN",u"备注",)
headercol={}
...
def checksize(strapplydate,strbirthday,strsize):
    result=u""
    ...
    if agedays > 92 and getsize(strsize) == "NB":
        result=u"宝宝月龄不符"
    elif agedays < -183 :
        result=u"预产期不符"
    return result
...
def formattrade(content, trade_id=None, express=u"韵达"):
    trade=[]
    trade.append(content[headercol[u"tid"]].strip())
    ...
    if headercol.has_key(u"barCode"):
        trade.append(content[headercol[u"barCode"]])
    elif pg_barcode.has_key(content[headercol[u"product_title"]]):
        trade.append(pg_barcode[content[headercol[u"product_title"]]])
    elif content[headercol[u"product_title"]] in pg_trial:
        trade.append(pg_trial[content[headercol[u"product_title"]]])
#    elif shop_id[content[headercol[u"shop_id"]]] == "63":
    elif shop_id.has_key(content[headercol[u"shop_id"]]) and shop_id[content[headercol[u"shop_id"]]] == "120":  #考拉
        trade.append(u"4902430706278")
    elif shop_id.has_key(content[headercol[u"shop_id"]]) and shop_id[content[headercol[u"shop_id"]]] in ("106", "98", "126"): #贝贝/蜜芽/妈妈网
        trade.append(bb_barcode[content[headercol[u"product_title"]]])
    elif content[headercol[u"shop_id"]] in gdt_shop_id or (shop_id.has_key(content[headercol[u"shop_id"]]) and shop_id[content[headercol[u"shop_id"]]] in gdt_shop_id ): #广点通
    ...
    trade.append(content[headercol[u"product_title"]])

    #trade.append(content[headercol[u"orderGoods_Num"]])
    if headercol.has_key(u"shop_id") and (content[headercol[u"shop_id"]] in gdt_shop_id or (shop_id.has_key(content[headercol[u"shop_id"]]) and shop_id[content[headercol[u"shop_id"]]] in gdt_shop_id )):
        trade.append("2")
    elif trade[6] in (u"6903148241110",u"6903148239797"):  #1片装发4份
        trade.append("4")
    else:
        trade.append("1")

    if pg_barcode.has_key(content[headercol[u"product_title"]]):
        trade.append(u"49")
    elif content[headercol[u"product_title"]] in pg_trial:
        trade.append(u"48")
    elif shop_id.has_key(content[headercol[u"shop_id"]]):
    ...
    trade.append("1")
    if headercol.has_key(u"wrong_reason"):
        if content[headercol[u"wrong_reason"]] == u"":
            content[headercol[u"wrong_reason"]]=content[headercol[u"remark"]]
    ...
    if headercol.has_key(u"shop_id"):
        ...
        trade.append("")
    if headercol.has_key(u"in_memo"):
        trade.append(formatdatetime(content[headercol[u"in_memo"]]))
    else:
        trade.append("")

    # # 缺货替换sku
    # if trade[6]=="6903148238905" :
    #     trade[6]="6903148236192"
    #     trade[12]="2"
    return trade
...
#        content[headercol[u"address"]]=fulladdr
    ...
    if headercol.has_key(u"in_memo"):
        content[headercol[u"remark"]]+=checksize(content[headercol[u"order_date"]],content[headercol[u"in_memo"]],content[headercol[u"product_title"]])
...
header = ["out__tid", "buyer_id", "out_tid", "consignee", "order_date", "mobilPhone", "barCode", "province", "city",
          ...
          "city_class", "standard", "wrong_reason", "distributor_no", "in_memo"]
...
with open(args.input_csv, 'rb') as f:
    ...
    reader = UnicodeReader(f)
    headers = reader.next()
    for idx in range(0,len(headers)-1):
        headers[idx]=headers[idx].lstrip().rstrip()
...
#快递质量测试. mark on 2016/5/20 by ahao
...
#    print v
    ...
    try:
        content = formattrade(procaddress(dict87w[v]), trade_id, express)
